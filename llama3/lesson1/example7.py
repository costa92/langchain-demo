...
def lookup_fact(keyword):
    # 使用ollama的chat接口
    """
    Retrieve a predefined fact from a knowledge base.
    """
    ...
    facts = {
        ...
        "mass of earth": "The mass of the Earth is about 5.972 × 10^24 kg.",
        "mass of moon": "The moon is about 7.348 × 10^22 kg.",
    }
...
# 注册工具
tool_registry.register("lookup_fact", "Lookup a fact from a knowledge base.", lookup_fact)
tool_registry.register("calculate", "Safely evaluate a mathematical expression.", calculate)
